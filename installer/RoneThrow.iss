; ============================================================================
; RONE Throw — Silent Plugin Installer
...
#endif
AppId={{547A9CAA-B46F-414C-BFEE-7699EB212906}
AppName=RONE Throw
AppVersion={#MyAppVersion}
AppPublisher=Liran Rone Kalifa
DefaultDirName={commonpf}\RONE Plugins
DisableProgramGroupPage=yes
OutputBaseFilename=RoneThrow_Installer_v{#MyAppVersion}
...
UninstallDisplayName=RONE Throw (RONE)
...
[Files]
; VST3 plugin bundle
Source: "..\RoneThrow\build-ci\RoneThrow_artefacts\Release\VST3\RONE Throw.vst3\*"; \
  DestDir: "{commoncf}\VST3\RONE\RONE Throw.vst3"; \
  Flags: ignoreversion recursesubdirs createallsubdirs

; Standalone executable
Source: "..\RoneThrow\build-ci\RoneThrow_artefacts\Release\Standalone\RONE Throw.exe"; \
  DestDir: "{app}"; \
  Flags: ignoreversion
...
Source: "..\docs\manuals\RONE Throw - User Manual.pdf"; \
  DestDir: "{app}\Manuals"; \
