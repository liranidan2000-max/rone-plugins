...
{legend([
 ...
 ("MIX", "dry/wet of the stuck signal - ride it down to pull a long roll back under the mix"),
...
{ctl("MIX", "0 to 100 %<br>default 100 %<br>automatable, smoothed", "<p>Dry/wet of the stuck signal, in the bottom right corner. At 100 % you hear the plugin exactly as it has always sounded, and at OFF the control does nothing at all - the effect only exists while STUCK is up. Below 100 % the frozen loop is blended back into the live input.</p><p>The wet path keeps running underneath, so you can take MIX to zero in the middle of a roll and bring it back without a click or a jump in the loop.</p>", "Automate MIX down over the second half of a long build: the roll keeps rising but steps out of the way of the vocal. Double-click the knob to snap back to 100 %.")}
