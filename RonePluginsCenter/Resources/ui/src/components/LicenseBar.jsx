      ...
      <AnimatePresence mode="wait">
        {license.licensed ? (
          <motion.div
            ...
            className="flex-shrink-0 h-11 surface-1 border-b border-rone-border/30 flex items-center px-5 gap-3"
          >
            {/* Avatar circle */}
          ...
          <motion.div
            ...
            exit={{ opacity: 0, y: 10 }}
            transition={{ duration: 0.3, ease: 'easeOut' }}
            className="flex-shrink-0 surface-1 border-b border-rone-border/30 px-5 py-2.5"
          >
