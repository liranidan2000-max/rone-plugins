#include "RoneReverbEngine.h"

namespace
{
    // Base FDN delay lengths in samples @48kHz (mutually prime, ~35–78ms)
    constexpr int kBaseDelays48k[RoneReverbEngine::kNumLines] = {
    ...
    constexpr int kDensDelays48k[RoneReverbEngine::kNumLines] = {
...
// =============================================================================
void RoneReverbEngine::prepare (double sampleRate, int /*maxBlockSize*/)
{
...
// Parameter setters
// =============================================================================
void RoneReverbEngine::setSize (float size01)
{
...
void RoneReverbEngine::setDecaySeconds (float seconds)
{
    decaySeconds_ = juce::jlimit (0.2f, 30.0f, seconds);
    updateFeedbackGains();
}

void RoneReverbEngine::updateFeedbackGains()
{
...
void RoneReverbEngine::setModDepth (float amount01)
{
...
void RoneReverbEngine::setHighDamp (float amount01)
{
...
void RoneReverbEngine::setLowDamp (float amount01)
{
...
void RoneReverbEngine::setEarlyLateBalance (float balance)
{
...
void RoneReverbEngine::setFreeze (bool shouldFreeze)
{
...
// Processing
// =============================================================================
float RoneReverbEngine::readInterp (const std::vector<float>& buf, int bufSize,
...
void RoneReverbEngine::processSample (float inL, float inR, float& outL, float& outR)
{
