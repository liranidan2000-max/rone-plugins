...
// =============================================================================
// RoneReverbEngine — AFTERSPACE late-field reverb
//
// Topology (spec §14/§15):
...
class RoneReverbEngine
{
public:
    static constexpr int kNumLines = 8;

    RoneReverbEngine() = default;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (RoneReverbEngine)
};
